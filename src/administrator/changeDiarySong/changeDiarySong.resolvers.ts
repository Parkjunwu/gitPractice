...
const changeDiarySongFn:Resolver = async(_,{diaryId,youtubeId,password},{client}) => {
  ...
  await pushNotificationSongSelected(client,"MUSIC_CHANGED",updateOkThenReturnUserId,diaryId);
