...
const uploadDiaryFn: Resolver = async(_,{title,fileArr,body,thumbNailArr,isFirstVideo,dateTime,youtubeId,requestMusic,showDiary,requestMessage,summaryBody,}:{title:string,fileArr:Array<any>,body:Array<string>,thumbNailArr?:Array<any>,isFirstVideo:boolean,dateTime:string,youtubeId?:string,requestMusic:boolean,showDiary?:boolean,requestMessage?:string,summaryBody?:string},{client,logInUserId}) => {
