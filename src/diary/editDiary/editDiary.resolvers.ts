...
const editDiaryFn: Resolver = async(_, {id, title, body, changeThumbNail, addFileArr, addFileIndexArr, addThumbNailArr, deleteFileArr, wholeFileArr, youtubeId, summaryBody,}:{id:number, title?:string, body?:Array<string>, changeThumbNail?:boolean|null, addFileArr?:Array<any>, addFileIndexArr?:Array<number>, addThumbNailArr?:Array<number>, deleteFileArr?:Array<string>, wholeFileArr?:Array<string>, youtubeId:string | null | undefined, summaryBody?:string|null}, {client, logInUserId}) => {
