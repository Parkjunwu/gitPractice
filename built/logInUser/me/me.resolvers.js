...
const resolver = {
    Query: {
        ...
        me: async (_, __, { logInUserId }) => {
            ...
            // const totalUnreadNotification = getTotalUnreadNotification(userId,loggedInUser.lastReadNotificationId);
            const totalUnreadNotification = (0, logInUser_util_1.getTotalUnreadNotification)(userId, logInUser.lastReadNotificationId);
