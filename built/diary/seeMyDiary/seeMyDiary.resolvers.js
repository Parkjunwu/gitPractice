...
// const seeMyDiaryFn: Resolver = async(_,{id},{client,loggedInUser}) => {
const seeMyDiaryFn = async (_, { id }, { client, logInUserId }) => {
...
const resolver = {
    Query: {
        seeMyDiary: (0, user_utils_1.protectResolver)(seeMyDiaryFn),
    },
};
