...
exports.pushNotificationSongSelected = void 0;
const fcmAppNotification_1 = require("./fcmAppNotification");
const getNotificationMessage_1 = __importDefault(require("./getNotificationMessage"));
const pubsub_1 = __importStar(require("./pubsub"));
const pushNotificationSongSelected = async (client, whichNotification, subscribeUserId, diaryId) => {
    try {
        ...
        if (token) {
            ...
            const message = (0, getNotificationMessage_1.default)(whichNotification);
            // FCM 은 string 만 가능
            const paramsObj = { diaryId: diaryId + "" };
            (0, fcmAppNotification_1.sendSinglePushNotification)(channel, token, message, paramsObj);
        }
        // subscription 전송
        await pubsub_1.default.publish(pubsub_1.NEW_NOTIFICATION, { userNotificationUpdate: notification });
    }
    catch (e) {
        console.log(e);
...
exports.pushNotificationSongSelected = pushNotificationSongSelected;
