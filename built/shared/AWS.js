...
exports.S3_FOLDER_NAME = exports.async_deletePhotoS3 = exports.async_uploadThumbNailS3 = exports.async_uploadPhotoS3 = void 0;
const AWS = __importStar(require("aws-sdk"));
const superagent_1 = __importDefault(require("superagent"));
const sendEmailUploadErrorToAdmin_1 = __importDefault(require("./sendEmailUploadErrorToAdmin"));
AWS.config.update({
    credentials: {
...
const async_uploadPhotoS3 = async (fileToUpload, userId, dateForUnique, folderName) => {
    try {
        ...
        (0, sendEmailUploadErrorToAdmin_1.default)();
        throw new Error("AWS upload error");
    }
};
exports.async_uploadPhotoS3 = async_uploadPhotoS3;
// folderName S3 에 저장할 폴더명임.
// export const async_uploadThumbNailS3 = async(fileToUpload, userId) => {
const async_uploadThumbNailS3 = async (fileToUpload, userId, dateForUnique) => {
    const { file: { filename, createReadStream, mimetype } } = await fileToUpload;
...
exports.async_uploadThumbNailS3 = async_uploadThumbNailS3;
...
const async_deletePhotoS3 = async (fileUrl) => {
    ...
    if (isVideo) {
        ...
        const { text } = await superagent_1.default.get(fileUrl).buffer(true).parse(superagent_1.default.parse.text);
...
exports.async_deletePhotoS3 = async_deletePhotoS3;
...
//   return data;
// };
exports.S3_FOLDER_NAME = "uploads";
