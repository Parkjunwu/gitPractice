...
exports.sendSinglePushNotification = exports.sendManyPushNotification = void 0;
...
// 여러 기기에 보냄.
const sendManyPushNotification = (channelId, tokens, message) => {
    (0, messaging_1.getMessaging)().sendMulticast({
        tokens,
        notification: {
            title: deviceShownTitle,
            body: message,
...
exports.sendManyPushNotification = sendManyPushNotification;
// 얘 말고 밑에 ~~~PushNotification 쓰는게 나을듯. 걔네는 매개변수들도 같이 보냄
// 한 기기기에만 보냄.
const sendSinglePushNotification = (channelId, token, message, params) => {
    (0, messaging_1.getMessaging)().send({
        token,
        notification: {
            title: deviceShownTitle,
            body: message,
